// deleted-status.type.ts

/**
 * Status codes for deleted items.
 * These values are typically used as integer flags or enums to track how an item
 * was removed or modified within the system.
 */
export enum DeletedStatus {
    // Negative values represent specific deletion/modification actions
    ...
    // Positive values represent causes or historical deletion methods
